...
/** Max orbs / speed portals a level may contain (sim keeps a 32-bit usage mask). */
 ...
 * x ordering ("monotonic-ish": non-deco objects never move backwards), and
 * no overlapping solids. Returns a list of human-readable errors (empty = ok).
 */
